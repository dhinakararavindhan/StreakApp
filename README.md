...
3. **Start the site in one click** (optional, from the Company page):
   - **Starter kits** — 21 pre-configured business templates across six categories: Food & Hospitality (café, restaurant, boutique hotel), Services (medical clinic, salon & spa, fitness studio, law firm, auto repair, contractor), Property (real-estate agency), Creative & Retail (portfolio, photography, boutique, agency, band), Community & Education (nonprofit, school, events & weddings), and Product & Publishing (product site, docs, changelog, blog). Each applies a matching theme + typography + layout and publishes real, ready-to-edit starter content — and business kits **install custom content types** where the business has structured content: the hotel ships a *Room* type (sleeps, nightly rate, view, booking link) with three rooms, real estate ships *Properties*, fitness ships *Classes*, the school ships *Courses*, the band ships *Shows*. Existing content and types are never touched.
